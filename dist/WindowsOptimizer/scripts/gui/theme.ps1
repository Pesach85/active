...
# Dot-sourced by system-optimizer-gui.ps1 â€” variables land in caller scope.

$script:appVersion = "3.11.3"
...
# Flat button factory â€” regular font + padding avoids clipped Italian labels
function New-Btn {
